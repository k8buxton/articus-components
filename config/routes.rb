Rails.application.routes.draw do
  ...
  get 'blog-show-2', to: 'pages#blog_show_2'
  get 'blog-show-3', to: 'pages#blog_show_3'
  get 'blog-show-4', to: 'pages#blog_show_4'
  get 'blog-show-5', to: 'pages#blog_show_5'
  get 'blog-show-6', to: 'pages#blog_show_6'
  get 'careers', to: 'pages#careers'
  get 'case-studies', to: 'pages#case_studies'
  get 'case-study-show', to: 'pages#case_study_show'
  get 'case-study-show-2', to: 'pages#case_study_show_2'
  get 'case-study-show-3', to: 'pages#case_study_show_3'
  get 'case-study-show-4', to: 'pages#case_study_show_4'
  get 'case-study-show-5', to: 'pages#case_study_show_5'
  get 'case-study-show-6', to: 'pages#case_study_show_6'
